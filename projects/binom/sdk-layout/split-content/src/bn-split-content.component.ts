import { Component, ContentChildren, ElementRef, Input, QueryList, Renderer2, inject } from '@angular/core';
...
export class BnSplitContentComponent {
  ...
  private renderGrid(){
    ...
    if(this.direction === 'vertical' && this.el.nativeElement.offsetWidth < (this.items.length + 1) * this.minItemWidth){
